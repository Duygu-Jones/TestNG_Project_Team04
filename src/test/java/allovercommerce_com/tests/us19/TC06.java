...
public class TC06 {
    ...
    public void testCustomerButWithCoupon() {
        ...
        ReusableMethods.extentReportCreate("Ibrahim",
                ...
                "TC_06 || Kullanıcı ürünleri satın alabilmek için fatura adresini görebilmeli");
        ...
        ReusableMethods.extentTestInfo("Müsteri bilgilerinin görüntülendigi dogrulandi.");
