...
public class TC05 {
    ...
    public void testCustomerButWithCoupon() {
        ...
        ReusableMethods.extentReportCreate("Ibrahim",
                ...
                "TC_05 || Kullanıcı sepete eklediği ürünlerin miktarını azaltabilmeli");
        ...
        //Ürün azaltma
        productPage.productMinus.click();
        ReusableMethods.extentTestInfo("Ürün miktari azaltildi.");
        ...
        Assert.assertEquals(actualQuantity,"0");
