...
public class TC07 {
    ...
    public void testCustomerButWithCoupon() {
        ...
        ReusableMethods.extentReportCreate("Ibrahim",
                ...
                "TC_07 || Kullanıcı ödeme seçeneklerini görebilmeli ");
        ...
        //payment methods
        String expectedPaymentMethodsTitle = "Payment Methods";
        String actualPaymentMethodsTitle = ordersPage.paymentMethodsText.getText();
        Assert.assertEquals(actualPaymentMethodsTitle,expectedPaymentMethodsTitle);
        ReusableMethods.extentTestPass("Payment MEthods görüntülendigi dogrulandi.");
