...
public class TC03 {
    ...
    public void test01() {
        ...
        ReusableMethods.extentReportCreate("Salih", "US04- Kullanıcı Shipping Adress ekleyebilmeli", "TC03 Kullanıcı Shipping Address kısmındaki Lastname alanını doldurmazsa shipping adress ekleyememeli");
        ...
        //"Last name" kutusunu boş bırak.
        ReusableMethods.deleteAll(myAccountPage.shippingAddressLastnameBoxST);
        ReusableMethods.extentTestInfo("'Last name' kutusu boş bırakıldı");
        ...
        //'Last name is a required field.' metni görülmeli
        String expectedData = "Last name is a required field.";
        ReusableMethods.verifyData(myAccountPage.addressNotChangedLastNameRequiredST, expectedData);
        ReusableMethods.extentTestInfo("'Last name is a required field.' metni görüldü");
