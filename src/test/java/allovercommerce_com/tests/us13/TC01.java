...
public class TC01 {
 ...
 public void test01() {
  ...
  ReusableMethods.extentReportCreate("Fatma","Tüm alanlar doldurulduğunda shipping address ekleyebilmeli",
          "Shipping adress eklendiği doğrulanır.");
  ...
  shippingAddressPage.company.sendKeys(company, Keys.TAB);
