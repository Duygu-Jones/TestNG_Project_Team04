...
public class TC11 {
    @Test
    public void test11() {
        //ReusableMethods.extentReportCreate("Selma Simsek", "US03","TC11");
       ...
       // Phone kutusu bos birakilir
        addressPage.phoneTextBoxSS.sendKeys("");

        addressPage.saveAddressButtonSS.click();
        ReusableMethods.waitForSecond(2);

        //Adres bilgisi kayit isleminin yapilamadigi dogrulanir
        String expectedbosTextAlertText = "Phone is a required field.";
        ...
        ReusableMethods.extentTestPass("Phone kutusu bos biralilarak islem kaydi yapilamadigi dogrulandi");
