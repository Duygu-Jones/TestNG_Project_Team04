...
public class TC08 {
    @Test
    public void test08() {
        ReusableMethods.extentReportCreate("U1T8 Selma", "US01","TC08");
        ...
        // Your Email address kutusuna gecerli bir veri girilir. abcgmail.com formatinda
        ...
        ReusableMethods.extentTestPass("abcgmail.com formatinda email ile kayit isleminin gerceklesmedigi dogrulandi. ");
