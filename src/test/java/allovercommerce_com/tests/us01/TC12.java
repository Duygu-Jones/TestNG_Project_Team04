...
public class TC12 {
    @Test
    public void test12() {
        ReusableMethods.extentReportCreate("U1T12 Selma", "US01","TC12");
        ...
        signUpInPage.signUpPasswordTextBoxSS.sendKeys("");
        ...
        ReusableMethods.extentTestPass("Password bilgisi girilmeden kayit isleminin gerceklesmedigi dogrulandi. ");
